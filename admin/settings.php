                        ...
                        <div class="dig_sts_logo">
                            ...
                            <ul class="dig_gs_log_men">
                                ...
                                <li><a id="dig_activatetab" href="?page=digits_settings&tab=activate"
                                       ...
                                       tab="activatetab"><?php _e('Registered', 'digits'); ?></a></li>
                            </ul>
                        </div>
                            ...
                            <div class="dig-tab-wrapper">
                                ...
                                <ul class="dig-tab-ul">
                                    ...
                                    <li><a href="?page=digits_settings&tab=shortcodes"
                                           ...
                                           <?php if ( is_plugin_active( 'dig_mergphne/dig_mergphne.php' ) ) : ?>
                                       <li><a href="?page=digits_settings&tab=digmergphne"
                                              class="updatetabview dig-nav-tab <?php echo $active_tab == 'digmergphne' ? 'dig-nav-tab-active' : ''; ?>"
                                              tab="digmergphnetab"><?php _e('Merge Phone Number', 'digits'); ?></a></li>
                                   <?php endif; ?>
                                   <?php if ( is_plugin_active( 'dig_oldaccntmr/dig_oldaccntmr.php' ) ) : ?>
                                       <li><a href="?page=digits_settings&tab=digoldaccntmr"
                                              class="updatetabview dig-nav-tab <?php echo $active_tab == 'digoldaccntmr' ? 'dig-nav-tab-active' : ''; ?>"
                                              tab="digoldaccntmrtab"><?php _e('Old Account Migrator', 'digits'); ?></a></li>
                                   <?php endif; ?>
